...
function tokenize(source, url, getTagDefinition, tokenizeExpansionForms, interpolationConfig) {
    ...
    if (interpolationConfig === void 0) { interpolationConfig = interpolation_1.DEFAULT_INTERPOLATION_CONFIG; }
...
var _Tokenizer = (function () {
    ...
    function _Tokenizer(_file, _getTagDefinition, _tokenizeIcu, _interpolationConfig) {
        if (_interpolationConfig === void 0) { _interpolationConfig = interpolation_1.DEFAULT_INTERPOLATION_CONFIG; }
        this._file = _file;
