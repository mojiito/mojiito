 ...
 */
var KeyValueDifferFactory = (function () {
    function KeyValueDifferFactory() {
    }
    KeyValueDifferFactory.prototype.supports = function (obj) { return obj instanceof Map || utils_1.isObject(obj); };
...
var KeyValueDiffer = (function () {
    ...
    KeyValueDiffer.prototype.diff = function (map) {
        ...
        else if (!(map instanceof Map || utils_1.isObject(map))) {
    ...
    KeyValueDiffer.prototype._maybeAddToChanges = function (record, newValue) {
        if (!utils_1.looseIdentical(newValue, record.currentValue)) {
            record.previousValue = record.currentValue;
    ...
    KeyValueDiffer.prototype.toString = function () {
        ...
        var record;
        for (record = this._mapHead; record !== null; record = record._next) {
            items.push(utils_1.stringify(record));
        }
        for (record = this._previousMapHead; record !== null; record = record._nextPrevious) {
            previous.push(utils_1.stringify(record));
        }
        for (record = this._changesHead; record !== null; record = record._nextChanged) {
            changes.push(utils_1.stringify(record));
        }
        for (record = this._additionsHead; record !== null; record = record._nextAdded) {
            additions.push(utils_1.stringify(record));
        }
        for (record = this._removalsHead; record !== null; record = record._nextRemoved) {
            removals.push(utils_1.stringify(record));
        }
...
var KeyValueChangeRecord = (function () {
    ...
    KeyValueChangeRecord.prototype.toString = function () {
        return utils_1.looseIdentical(this.previousValue, this.currentValue) ?
            utils_1.stringify(this.key) :
            (utils_1.stringify(this.key) + '[' + utils_1.stringify(this.previousValue) + '->' +
                utils_1.stringify(this.currentValue) + ']');
    };
