...
export function applyActionsToController(controller) {
    ...
    let actionElements = Array.prototype.slice.call(querySelectorAll(controller.get('_$', true),
        '[data-' + (ENV.HTMLDATA_SHORTHAND ? ENV.HTMLDATA_ACTION_SHORTHAND : ENV.HTMLDATA_ACTION) + ']'));

    if(getAttribute(controller.get('_$', true), 'data-' + (ENV.HTMLDATA_SHORTHAND ? ENV.HTMLDATA_ACTION_SHORTHAND : ENV.HTMLDATA_ACTION))) {
...
export function applyClassBindingsToController(controller) {
    ...
    let bindingElements = Array.prototype.slice.call(querySelectorAll(controller.get('_$', true),
        '[data-' + (ENV.HTMLDATA_SHORTHAND ? ENV.HTMLDATA_CLASSBINDING_SHORTHAND : ENV.HTMLDATA_CLASSBINDING) + ']'));

    if(getAttribute(controller.get('_$', true), 'data-' + (ENV.HTMLDATA_SHORTHAND ? ENV.HTMLDATA_CLASSBINDING_SHORTHAND : ENV.HTMLDATA_CLASSBINDING))) {
