...
import { register, registerController, applyController, applyControllers, getControllersByParam, getControllerById, getControllerByRef, getControllersByClassName } from './core';
...
const Mojito = {
    ...
    applyControllers: applyControllers,
