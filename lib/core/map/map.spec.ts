...
import { CoreMap, TypedMap } from './map';
...
describe('CoreMap', () => {
    ...
    describe('entries', () => {
        ...
        it('it should return an iterator for iterating the items', () => {
            ...
            expect(interator instanceof Iterator).toBeTruthy();
...
describe('TypedMap', () => {
    it('it exists and can be created', () => {
        const map = new TypedMap<any, any>();
        expect(map instanceof TypedMap).toBe(true);
    });
    ...
    describe('new', () => {
        ...
        it('it should create a map out of an array', () => {
            ...
            const map = new TypedMap<string, string>(kvArray);
            expect(map.size).toBe(2);
            expect(map.get('key1')).toBe('value1');
            expect(map.get('key2')).toBe('value2');
    ...
    describe('create', () => {
        it('it should exist', () => {
            expect(typeof TypedMap.create).toBe('function');
        });
        it('it should create a new instance of TypedMap', () => {
            expect(TypedMap.create() instanceof TypedMap).toBeTruthy();
        });
    });
});