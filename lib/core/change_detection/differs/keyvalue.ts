import { looseIdentical, stringify, isObject } from '../../../utils/utils';
...
export class KeyValueDifferFactory {
    ...
    supports(obj: any): boolean { return obj instanceof Map || isObject(obj); }

    create(cdRef: ChangeDetector): KeyValueDiffer { return new KeyValueDiffer(); }
}
...
export class KeyValueDiffer {
    ...
    private _forEach<K, V>(obj: Map<K, V> | { [key: string]: V }, callback: (value: V, key: K | string) => void) {
