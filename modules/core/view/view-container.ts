...
import { AppView, ViewRef } from './view';
...
export class ViewContainerRef {
    ...
    createComponent<C>(componentFactory: ComponentFactory<C>, index: number = -1,
        injector: Injector = null, nativeElement: Element): ComponentRef<C> {
        const contextInjector = injector || this._element.parentInjector;
        const componentRef = componentFactory.create(contextInjector, nativeElement);
        return componentRef;
    }
